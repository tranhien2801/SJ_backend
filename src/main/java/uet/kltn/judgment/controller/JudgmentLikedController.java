...
import uet.kltn.judgment.service.JudgmentLikedService;
...
public class JudgmentLikedController extends GenController{
    @Autowired
    private JudgmentLikedService judgmentLikedService;
    ...
    public ResponseEntity<?> getJudgmentsViewed(@CurrentUser UserPrincipal userPrincipal,
        ...
        try {
            ...
            response = judgmentLikedService.getJudgmentsLiked(expressionDto, userPrincipal.getId(), filterJudgmentRequestDto);
            if (response == null) {
